...
macro(
  ...
  elseif(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang|GNU")
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
      string(APPEND NEW_COMPILE_OPTIONS " -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=0")
      message(STATUS "*** g++/clang _FORTIFY_SOURCE=0 enabled")
    else()
      string(APPEND NEW_COMPILE_OPTIONS " -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=3")
  ...
  if(${ubsan_minimal_runtime})
    check_cxx_compiler_flag("-fsanitize=undefined -fno-sanitize-recover=undefined -fsanitize-minimal-runtime"
                            MINIMAL_RUNTIME)
    if(MINIMAL_RUNTIME)
      string(APPEND NEW_COMPILE_OPTIONS " -fsanitize=undefined -fsanitize-minimal-runtime")
      string(APPEND NEW_LINK_OPTIONS " -fsanitize=undefined -fsanitize-minimal-runtime")
  ...
  if(${global})
    ...
    separate_arguments(NEW_COMPILE_OPTIONS NATIVE_COMMAND ${NEW_COMPILE_OPTIONS})
    separate_arguments(NEW_LINK_OPTIONS NATIVE_COMMAND ${NEW_LINK_OPTIONS})
    separate_arguments(NEW_CXX_DEFINITIONS NATIVE_COMMAND ${NEW_CXX_DEFINITIONS})
